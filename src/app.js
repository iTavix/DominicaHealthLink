...
const lucide = { createIcons: (opts) => createIcons({ icons: lucideIcons, ...(opts || {}) }) };
  ...
  // =====================================================================================
  //  DominicaHealthLink — Gestionale Trasferimento Infermieri (Repubblica Dominicana → Italia)
  ...
  function manualBodyIT() {
    return `
      ...
      <section id="intro" class="space-y-4">
        ...
        <p class="text-sm leading-relaxed text-slate-600">DominicaHealthLink è il gestionale che segue ogni candidato infermiere lungo l'intero percorso burocratico: dall'acquisizione del profilo fino all'inserimento nella struttura sanitaria italiana. Ogni candidato è una <b>pratica</b> che attraversa <b>11 stati sequenziali</b>. Il sistema impedisce di saltare passaggi e segnala le pratiche in ritardo.</p>
  ...
  function manualBodyEN() {
    return `
      ...
      <section id="intro" class="space-y-4">
        ...
        <p class="text-sm leading-relaxed text-slate-600">DominicaHealthLink tracks each nurse candidate along the entire bureaucratic path: from acquiring the profile to integration into an Italian facility. Each candidate is a <b>case</b> that goes through <b>11 sequential states</b>. The system prevents skipping steps and flags overdue cases.</p>
        <div class="grid gap-3 sm:grid-cols-3">
