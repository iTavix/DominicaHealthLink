...
function guideBodyEN() {
  return `
      ...
      <section id="g-percorso-op" class="space-y-4">
        ...
        <div class="rounded-xl border-l-4 border-indigo-400 bg-indigo-50 p-4 text-sm text-indigo-800"><b>In the app.</b> Every case has the <b>"Professional Placement &amp; Residence"</b> card: choose the Phase 1 channel (1.A/1.B with issuing Region) and the Phase 2 channel (2.A/2.B), attach on each item the document that proves the obligation — the tick happens by itself on upload — and once the entry date and clearance date are set the <b>traffic lights compute the statutory deadlines automatically</b> (48 hours, 8/15 days, 180 days).</div>
      </section>
...
function guideBodyES() {
  return `
      ...
      <section id="g-percorso-op" class="space-y-4">
        ...
        <div class="rounded-xl border-l-4 border-indigo-400 bg-indigo-50 p-4 text-sm text-indigo-800"><b>En la app.</b> Cada expediente tiene la tarjeta <b>«Inserción Profesional &amp; Residencia»</b>: eliges el canal de la Fase 1 (1.A/1.B con Región emisora) y de la Fase 2 (2.A/2.B), adjuntas en cada punto el documento que demuestra el trámite — la marca se pone sola al subirlo — y al introducir la fecha de entrada y la del Nulla Osta los <b>semáforos calculan automáticamente los plazos legales</b> (48 horas, 8/15 días, 180 días).</div>
      </section>
